...
public class TelaListarPneumaticos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_listar_pneumaticos);

        //Criando uma lista para armazenar objetos do tipo "Produto"
        List<Produto> listaProdutos = new ArrayList<>();

        conexao.collection("produtos")
                .whereEqualTo("categoria","Ferramentas Pneumáticas")
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            RecyclerView recyclerTela = findViewById(R.id.idRecyclerPneumaticos);

                            //Passando a lista para o Adapter personalizado
                            ProdutoAdapter adapter = new ProdutoAdapter(listaProdutos, TelaListarPneumaticos.this);

                            //Configuração de um gestor de layout
                            recyclerTela.setLayoutManager(new LinearLayoutManager(TelaListarPneumaticos.this));
                            ...
                            Toast.makeText(TelaListarPneumaticos.this, "Erro de conexão", Toast.LENGTH_SHORT).show();
                        }
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(TelaListarPneumaticos.this, "Erro ao buscar", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        imagemVoltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(TelaListarPneumaticos.this, MainActivity.class);
                startActivity(it);
                finish();
            }
        });
