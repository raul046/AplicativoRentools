...
public class TelaListarEletricos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_listar_eletricos);
        //Criando uma lista para armazenar objetos do tipo "Produto"
        List<Produto> listaProdutos = new ArrayList<>();

        conexao.collection("produtos")
                .whereEqualTo("categoria", "Ferramentas Elétricas")
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            RecyclerView recyclerTela = findViewById(R.id.idRecycler);

                            //Passando a lista para o Adapter personalizado
                            ProdutoAdapter adapter = new ProdutoAdapter(listaProdutos, TelaListarEletricos.this);

                            //Configuração de um gestor de layout
                            recyclerTela.setLayoutManager(new LinearLayoutManager(TelaListarEletricos.this));
                            ...
                            Toast.makeText(TelaListarEletricos.this, "Erro de conexão", Toast.LENGTH_SHORT).show();
                        }
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(TelaListarEletricos.this, "Erro ao buscar", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        imageVoltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(TelaListarEletricos.this, MainActivity.class);
                startActivity(it);
                finish();
            }
        });
